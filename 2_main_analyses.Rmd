...
#### Figure S4: Probability of significant period with colony latitude
...
png(file = "Figures/FigureS4_prop_signif_periods.png", width = 9, height = 7, units = "in", res = 600)
plot.signif
dev.off()
...
#### Figure S6: Immersion trends by colony

```{r FIGURE_S6, eval = save_plot}

png("Figures/FigureS6_immersion_by_colony.png", 
...
#### Figure 3 & S8: Absolute deviation by colony
...
png("Figures/FigureS9_GAM_activity_by_sun.png", 
    width = 9, height = 7, units = "in", res = 600)
...
```{r FIGURE_S10_sun_elevation_randomisation_output, eval = save_plot}
...
png("Figures/FigureS10_GAM_randomisation_output.png", 
    width = 9, height = 7, units = "in", res = 600)
te_plot
dev.off()
