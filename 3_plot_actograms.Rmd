...
```{r FigureS6_plot_representative_birds}
...
png(paste0(actograms.path, "FigureS6_actograms_1.png"), width = 14, height = 9, units = "in", res = 600)
multiPlot1
dev.off()

png(paste0(actograms.path, "FigureS6_actograms_2.png"), width = 14, height = 9, units = "in", res = 600)
multiPlot2
dev.off()
